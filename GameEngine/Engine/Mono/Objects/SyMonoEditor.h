...
namespace mono
{
	...
	private:
		...
		//static ProxyVector2 GeDrawVector2Field(MonoString* rawName, ProxyVector2 val);
		static ProxyVector2 GeDrawVector2Field(float x, float y);
		static ProxyVector3 GeDrawVector3Field(MonoString* rawName, ProxyVector3 val);
		static ProxyVector4 GeDrawVector4Field(MonoString* rawName, ProxyVector4 val);
		static ProxyCurve GeDrawCurveField(MonoString* rawName, ProxyCurve curve);
