...
OpaqueShader::OpaqueShader(EngineCore* _engine)
{
    this->engine=_engine;
}

void OpaqueShader::Initialize(LPCWSTR shaderPath)
{
    ...
    /*res = D3DCompileFromFile(shaderPath, Shader_Macros /*macros#1#, nullptr /*include#1#,
        "GSMain", "gs_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
