...
PointLightShader::PointLightShader(EngineCore* _engine)
{
    this->engine=_engine;
}

void PointLightShader::Initialize(LPCWSTR shaderPath)
{
    ...
    res = D3DCompileFromFile(shaderPath, Shader_Macros /*macros*/, nullptr /*include*/,
        "PS_PointLight", "ps_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
