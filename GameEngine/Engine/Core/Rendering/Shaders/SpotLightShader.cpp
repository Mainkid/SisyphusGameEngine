...
SpotLightShader::SpotLightShader(EngineCore* _engine)
{

    this->engine=_engine;
}

void SpotLightShader::Initialize(LPCWSTR shaderPath)
{
    ...
    res = D3DCompileFromFile(shaderPath, Shader_Macros /*macros*/, nullptr /*include*/,
        "PS_SpotLight", "ps_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
